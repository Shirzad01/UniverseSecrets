            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => InkWell(
                onTap: widget.childClick == null
                    ? null
                    : () {
                  if (builtChildren[index]['width'] == widget.trailingChildWidth) {
                    if (builtChildren[index]['direction'] == 1) {
                      activeIndex++;
                      updateSlabs(false, 1);
                    } else {
                      activeIndex--;
                ...
                child: Container(
                  margin: EdgeInsets.only(
                    right: double.parse(builtChildren[index]['marginRight'].toString()),
                  ),
                  child: ClipRRect(
                    ...
                    child: AnimatedContainer(
                      ...
                      width: double.parse(builtChildren[index]['width'].toString()),
                      height: useHeight,
                      child: Stack(
                        fit: StackFit.expand,
                        children: [
                          Image.asset(
                            builtChildren[index]['childData']['image'],
                            fit: BoxFit.cover,
                          ...
                          Container(
                            ...
                            child: Align(
                              ...
                              child: AnimatedOpacity(
                                opacity: double.parse(builtChildren[index]['opacity'].toString()),
                                duration: Duration(milliseconds: widget.titleFadeAnimationDuration),
                                child: Text(
                                  builtChildren[index]['childData']['title'],
                                  style: TextStyle(
